...
<p align="center"><img width="100%" src="img/go-download.png"/></p>
...
<p align="center"><img width="100%" src="img/go-env.png"/></p>
在GOPATH下创建三个文件夹：

1. bin编译后生产的可执行文件和go相关的工具，都在此目录。把此目录加入Path环境变量下方便go的使用。
2. pkg编译过后生成的包文件存放目录。
3. src存放源代码的目录，新建项目都在该目录下。
<p align="center"><img width="100%" src="img/go-path.png"/></p>
